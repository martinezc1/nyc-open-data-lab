---
title: "The Impact Speed Cameras Have on Safety"
subtitle: "A NYC Speed Camera Analysis"
...
**Authors:** [Jonah Dratfield](../current-members/jonah-dratfield.qmd) & [Shannon Joyce](../contributors/shannon-joyce.qmd)
...
camera_dates_2014 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2014_20260407.parquet"))
camera_dates_2015 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2015_20260407.parquet"))
camera_dates_2016 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2016_20260407.parquet"))
camera_dates_2017 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2017_20260407.parquet"))
camera_dates_2018 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2018_20260407.parquet"))
camera_dates_2019 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2019_20260407.parquet"))
camera_dates_2020 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2020_20260407.parquet"))
camera_dates_2021 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2021_20260407.parquet"))
camera_dates_2022 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2022_20260407.parquet"))
camera_dates_2023 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2023_20260407.parquet"))
camera_dates_2024 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2024_20260407.parquet"))
camera_dates_2025 <- read_parquet(here("data", "processed", "Parking_Violations_Issued_-_Fiscal_Year_2025_20260407.parquet"))
...
crash_data <- read_parquet(
  here("data", "processed", "Motor_Vehicle_Collisions_-_Crashes_20260408.parquet")
) %>% clean_names()
...
crashes_final1 <- crash_data %>%
  filter(on_street_name != "" & cross_street_name != "") %>%
  mutate(
    ON_CLEAN = toupper(on_street_name) %>% 
      str_replace_all("\\bWEST\\b", "W") %>% 
      str_replace_all("\\bEAST\\b", "E"),
    CROSS_CLEAN = toupper(cross_street_name) %>% 
      str_replace_all("\\bWEST\\b", "W") %>% 
      str_replace_all("\\bEAST\\b", "E"),
...
analysis_df <- final_analysis_df1 %>%
  mutate(
    crash_date_clean = mdy(crash_date),
...
analysis_df <- analysis_df %>%
  mutate(
    total_injuries = number_of_persons_injured,
    total_deaths = number_of_persons_killed,
...
processed_deaths <- year_window %>%
  group_by(period) %>%
  summarize(total_deaths = sum(number_of_persons_killed, na.rm = TRUE))
```
...
processed_casualties <- year_window %>%
  group_by(period) %>%
  summarize(total_casualties = sum(number_of_persons_injured, number_of_persons_killed, na.rm = TRUE))
```
